...
class Upload extends Component {
    ...
    this.setState({confirmation: "Processando..."})
    await fetch('https://armazenamentokamila.s3.amazonaws.com/',
    {
        method: "POST",
        headers: {
    ...
    const response = await fetch(
        'https://armazenamentokamila.s3.amazonaws.com/ocr/',
        {
        method: "POST",
        headers: {
            Accept : "application/json",
